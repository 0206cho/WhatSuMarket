    ...
    <v-container style="max-width:1300px" fill-height>
        ...
        <v-layout align-center row wrap>
            ...
            <v-row>
                ...
                <v-col cols="4">
                    <v-card elevation="12" height="450" style="border-radius:25px; border: 1px solid #008037">
                        <v-img :src="require('../../images/WhatSuWhite.png')" max-height="80" max-width="190" style="margin: 1em auto;"></v-img>
                        ...
                        <v-card-actions class="py-0 mt-0">
                            <v-spacer></v-spacer>
                            <v-btn class="font-weight-bold body-2" plain>아이디 찾기</v-btn>
                            <v-btn class="font-weight-bold body-2" plain>비밀번호 찾기</v-btn>
                            <v-spacer></v-spacer>
                        </v-card-actions>
