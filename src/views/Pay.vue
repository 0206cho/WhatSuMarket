        ...
        <v-row justify="center" align="center">
            ...
            <v-col cols="4">
                ...
                <v-card align="center" elevation="12" style="border-radius:25px; border: 1px solid #008037">
                    ...
                    <v-img :src="require('../../images/WhatSuWhite.png')" max-height="100" max-width="95" style="margin: 1em auto; bottom: 2px;"></v-img>
    
    
    
                    <div style="text-align: center; color:#008037; position: relative; bottom: 15px; font-size:xx-large; font-family: 'KOTRA_BOLD';">
                    ...
                    <v-card height="140" style="border-radius:1em; border: 1px solid #008037" class="mx-2 mb-10">
                        ...
                        <v-app-bar height="40" color="#d2e9dc">
                            ...
                            <v-toolbar-title style="color: #008037;" class=" font-weight-bold subtitle-1 mt-1 ml-0 pl-0">&nbsp;주문 상품 정보
                        ...
                        <v-img :src="require('../../images/iphone.png')" max-height="150" max-width="100" style="float:left; left: 1em; top: 11px;"></v-img>
                        ...
                        <p style="position: relative; right:25px; top:13px;" class="subtitle-1 font-weight-bold"> 상품 : 아이폰 14 pro 미개봉</p>
                    ...
                    <v-card height="390" class="mx-2 mb-10" style="border-radius:1em; border: 1px solid #008037;">
                        ...
                        <v-app-bar height="40" color="#d2e9dc">
                            ...
                            <v-toolbar-title prepend-inner-icon="fa-light fa-coin" style="color: #008037;" class=" font-weight-bold subtitle-1 mt-1 ml-0 pl-0">&nbsp;주문/배송 정보
                        ...
                        <v-form>
                            ...
                            <v-card-text>
                                ...
                                <v-text-field v-model="pay.buyer.name" style=" max-width: 22.55em; bottom:3ex" class="shrink mx-4" dense label="이름" color="#008037" outlined clearable></v-text-field>
    
    
    
                                <v-text-field v-model="pay.buyer.phone" style=" max-width: 22.55em; bottom:2.5em" class="shrink mx-4" dense label="전화번호" color="#008037" outlined clearable></v-text-field>
                                ...
                                <v-text-field v-model="pay.addressInfo.address" style="max-width: 22.55em; bottom:4em" class="shrink mx-4" dense label="주소" color="#008037" outlined clearable></v-text-field>
    
    
    
                                <v-text-field v-model="pay.addressInfo.addressdetail" style="max-width: 22.55em; bottom:5em" class="shrink mx-4" dense label="상세주소" color="#008037" outlined clearable></v-text-field>
                    ...
                    <v-card height="110" class="mx-2 mb-5" style="border-radius:1em; border: 1px solid #008037;">
                        ...
                        <v-app-bar height="40" color="#d2e9dc">
                            ...
                            <v-toolbar-title prepend-inner-icon="fa-light fa-coin" style="color: #008037;" class="font-weight-bold subtitle-1 mt-1 ml-0 pl-0">&nbsp;포인트</v-toolbar-title>
                        ...
                        <v-text-field v-model="pay.point.insertpoint" style="max-width: 18em; bottom: 5px; right: 2em" class="shrink mx-4" dense label="냥" color="#008037" outlined clearable></v-text-field>
