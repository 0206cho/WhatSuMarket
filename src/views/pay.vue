    ...
    <v-container style="max-width:1300px" fill-height>
        <v-layout align-center row wrap>
            <v-row>
                ...
                <v-col cols="4"></v-col>
                <v-col cols="4">
                    <v-card align="center" elevation="12" max-width="800" max-height="1000"
                        ...
                        <v-col>
                            ...
                            <v-card width="400" height="390"
                                style="border-radius:1em; border: 1px solid #008037; bottom:2em">
                                <v-app-bar height="40" color="#d2e9dc">
                        ...
                        <v-col>
                            <v-card width="400" height="240"
                                style="border-radius:1em; border: 1px solid #008037; bottom:4.7em">
