        ...
        <v-row justify="center" align="center">
            <v-col cols="4">
                ...
                <v-card flat class="mx-auto rounded-lg" width="100%" height="100%" style="border:none;">
                    ...
                    <v-card-title class="pb-1" style="font-weight: bold;">소주</v-card-title>
                    <v-card-text class="pb-6">
                        ...
                        <p class="black--text pt-4" style="font-weight: bold; line-height: 35px;">10년 묵은 소주임다<br>상해서
                            배탈나도 책임 안져유~</p>
                    ...
                    <v-card-actions>
                        ...
                        <!--block : 꽉채우게~-->
                        <v-btn dark color="#008037" style="border-radius: 30px;" class="px-5">구매하기</v-btn>
                        <!--block : 꽉채우게~-->
                    </v-card-actions>
                </v-card>
            </v-col>
